...
export class GoodsInfoSkuListInfoInterface extends Interface {
  constructor(param) {
    ...
    try {
      ...
      throw new Exception(
        e,
        'GoodsInfoSkuListInfoInterface interface attribute error'
      )
    }
  }
}
...
export class GoodsInfoImagesInterface extends Interface {
  constructor(param) {
    ...
    try {
      ...
      throw new Exception(
        e,
        'GoodsInfoImagesInterface interface attribute error'
      )
    }
  }
}
...
export class GoodsInfoSkuListInfoSpecInfoInterface extends Interface {
  constructor(param) {
    ...
    try {
      ...
      throw new Exception(
        e,
        'GoodsInfoSkuListInfoSpecListInfoInterface interface attribute error'
      )
    }
  }
}
